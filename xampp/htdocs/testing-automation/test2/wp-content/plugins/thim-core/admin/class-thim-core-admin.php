...
if ( ! class_exists( 'Thim_Core_Admin' ) ) {
    class Thim_Core_Admin extends Thim_Singleton {
        ...
        public function enqueue_scripts() {
            wp_register_script( 'thim-core-admin', THIM_CORE_ADMIN_URI . '/assets/js/core.min.js', array( 'jquery' ), THIM_CORE_VERSION );
            ...
            wp_register_script( 'thim-video-youtube', THIM_CORE_ADMIN_URI . '/assets/js/youtube.js', array(
                'jquery',
                'youtube-api'
            ), THIM_CORE_VERSION );
        ...
        private function localize_script() {
            ...
            wp_localize_script( 'thim-core-admin', 'thim_core_settings', array(
                ...
                'is_free' => Thim_Free_Theme::is_free() ? 'yes' : 'no',
