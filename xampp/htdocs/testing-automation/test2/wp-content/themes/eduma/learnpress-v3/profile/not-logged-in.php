...
learn_press_display_message( sprintf( __( 'Please <a href="%s">login</a> to see your profile content', 'eduma' ), add_query_arg( 'redirect_to', get_permalink(), thim_get_login_page_url() ) ) );
