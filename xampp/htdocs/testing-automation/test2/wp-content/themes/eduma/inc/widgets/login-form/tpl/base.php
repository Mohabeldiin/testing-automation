...
<?php if ( isset( $_GET['result'] ) || isset( $_GET['action'] ) ) : ?>
	<?php if ( isset( $_GET['result'] ) && $_GET['result'] == 'failed' ): ?>
		<?php
		if ( ! empty( $_GET['thim_login_msg'] ) ) {
			echo sprintf( '<p class="message message-error">%s</p>', __( html_entity_decode( wp_unslash( $_GET['thim_login_msg'] ) ), 'eduma' ) );
		}
		?>
	<?php endif; ?>
	...
	<?php if ( ! empty( $_GET['action'] ) && $_GET['action'] == 'register' ) : ?>
		<?php if ( get_option( 'users_can_register' ) ) : ?>
			...
			if ( ! empty( $_GET['thim_register_msg'] ) ) {
				echo sprintf( '<p class="message message-error">%s</p>', __( html_entity_decode( wp_unslash( $_GET['thim_register_msg'] ) ), 'eduma' ) );
			}
			?>
...
//				}
	...
	if ( isset( $_GET['action'] ) && $_GET['action'] == 'lostpassword' ) :
		if ( ! empty( $_GET['thim_lostpass_msg'] ) ) {
			echo sprintf( '<p class="message message-error">%s</p>', __( html_entity_decode( wp_unslash( $_GET['thim_lostpass_msg'] ) ), 'eduma' ) );
		}
		?>
	...
	<?php if ( isset( $_GET['action'] ) && $_GET['action'] == 'rp' ) : ?>
		<?php
		if ( ! empty( $_GET['thim_resetpass_msg'] ) ) {
			echo sprintf( '<p class="message message-error">%s</p>', __( html_entity_decode( wp_unslash( $_GET['thim_resetpass_msg'] ) ), 'eduma' ) );
		}
		?>
