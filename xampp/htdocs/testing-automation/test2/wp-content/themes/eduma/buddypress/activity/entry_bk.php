...
<li class="<?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>">
	<div class="activity-avatar">
		<a href="<?php bp_activity_user_link(); ?>">
			...
			<?php bp_activity_avatar( array( 'width' => 70, 'height' => 70 ) ); ?>
		...
		<div class="activity-meta">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( 'Comment %s', 'eduma' ), '<span>' . bp_activity_get_comment_count() . '</span>' ); ?></a>
