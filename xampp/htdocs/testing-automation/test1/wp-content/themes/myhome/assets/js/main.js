...
(function ($) {
    "use strict";
    if ($('#estate_slider_card').revolution !== undefined && ($('#estate_slider_card').revolution instanceof Function)) {
        console.log('first')
    ...
    if ($('#estate_slider_card_short').revolution !== undefined && ($('#estate_slider_card').revolution instanceof Function)) {
    ...
    if ($('#estate_slider_transparent').revolution !== undefined && ($('#estate_slider_card').revolution instanceof Function)) {
    ...
    jQuery(window).on('load', function () {
        ...
        if ($(".mh-fixed-menu").length > 0) {
            ...
            if ($(".mh-top-header").length) {
                topHeight = $(".mh-top-header").innerHeight();
            }

            if ($(".mh-top-header-big").length) {
                topHeight += $(".mh-top-header-big").innerHeight()
            }
