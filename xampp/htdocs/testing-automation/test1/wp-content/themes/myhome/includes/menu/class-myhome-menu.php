    ...
    class My_Home_Menu
    {
        ...
        public function add_elements($items, $args)
        {
            ...
            if (!empty($panel) && $panel) {
                ...
                $submit_property_text = apply_filters('myhome/string/submit_property', esc_html__('Submit property', 'myhome'));
                ...
                <span class="item_link">
                    <span class="link_content">
                        <a
                                ...
                                title="<?php echo esc_attr($submit_property_text); ?>"
                        >
                            <?php echo esc_html($submit_property_text); ?>
