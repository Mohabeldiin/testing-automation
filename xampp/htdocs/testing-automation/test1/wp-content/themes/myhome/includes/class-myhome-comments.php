		...
		<div <?php comment_class( empty( $args['has_children'] ) ? 'mh-comment' : 'mh-comment parent' ); ?> id="comment-<?php comment_ID(); ?>">
			...
			<div class="mh-comment__content">
				...
				<div class="mh-comment__date">
					...
					edit_comment_link(
						'<span class="comment-edit-icon"></span><i class="fas fa-pencil-alt"></i>' . esc_html__( 'edit comment', 'myhome' ),
						'',
						''
					); ?>
				</div>
				...
				<?php comment_reply_link( array_merge( $args, array(
					'reply_text' => esc_html__( 'Reply', 'myhome' ) . '<i class="fas fa-reply" aria-hidden="true"></i>',
					'depth'      => $depth,
