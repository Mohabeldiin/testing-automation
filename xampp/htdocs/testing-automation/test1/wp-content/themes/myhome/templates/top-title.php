    ...
    >
		<?php if ( ! empty( $myhome_top_title_title ) ) : ?>
			<?php if ( is_singular( 'post' ) ) : ?>
                <div class="mh-top-title__heading"><?php echo wp_kses_post( $myhome_top_title_title ); ?></div>
			<?php else : ?>
                <h1 class="mh-top-title__heading"><?php echo wp_kses_post( $myhome_top_title_title ); ?></h1>
			<?php endif; ?>
		<?php endif; ?>
                                ...
                                <div class="mh-top-title__social-icons">
									<?php foreach ( $myhome_agent->get_social_icons() as $myhome_agent_social_icon ) : ?>
                                        <a href="<?php echo esc_url( $myhome_agent_social_icon->get_link() ); ?>"
                                           target="_blank">
                                            <i class="fab <?php echo esc_attr( $myhome_agent_social_icon->get_css_class() ); ?>"></i>
                                        </a>
									<?php endforeach; ?>
                                </div>
							<?php endif; ?>
