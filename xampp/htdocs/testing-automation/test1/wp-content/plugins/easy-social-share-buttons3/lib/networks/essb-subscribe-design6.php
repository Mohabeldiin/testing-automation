...
if (!function_exists('essb_subscribe_form_design6')) {
	function essb_subscribe_form_design6($salt, $is_widget = false, $position = '') {
		...
		$subscribe_mc_namefield = essb_object_bool_value($essb_options, 'subscribe_mc_namefield6');
		...
		$subscribe_mc_title = essb_object_value($essb_options, 'subscribe_mc_title6');
		$subscribe_mc_text = essb_object_value($essb_options, 'subscribe_mc_text6');
		$subscribe_mc_email = essb_object_value($essb_options, 'subscribe_mc_email6');
		$subscribe_mc_name = essb_object_value($essb_options, 'subscribe_mc_name6');
		$subscribe_mc_button = essb_object_value($essb_options, 'subscribe_mc_button6');
		$subscribe_mc_footer = essb_object_value($essb_options, 'subscribe_mc_footer6');
		$subscribe_mc_success = essb_object_value($essb_options, 'subscribe_mc_success6');
		$subscribe_mc_error = essb_object_value($essb_options, 'subscribe_mc_error6');
		...
		$subscribe_mc_image3 = essb_object_value($essb_options, 'subscribe_mc_image6');
		$subscribe_mc_imagealign3 = essb_object_value($essb_options, 'subscribe_mc_imagealign6');
