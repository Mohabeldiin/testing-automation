...
if (!function_exists('essb_subscribe_form_design9')) {
	function essb_subscribe_form_design9($salt, $is_widget = false, $position = '') {
		...
		$subscribe_mc_namefield = essb_object_bool_value($essb_options, 'subscribe_mc_namefield9');
		...
		$subscribe_mc_title = essb_object_value($essb_options, 'subscribe_mc_title9');
		$subscribe_mc_text = essb_object_value($essb_options, 'subscribe_mc_text9');
		$subscribe_mc_email = essb_object_value($essb_options, 'subscribe_mc_email9');
		$subscribe_mc_name = essb_object_value($essb_options, 'subscribe_mc_name9');
		$subscribe_mc_button = essb_object_value($essb_options, 'subscribe_mc_button9');
		$subscribe_mc_footer = essb_object_value($essb_options, 'subscribe_mc_footer9');
		$subscribe_mc_success = essb_object_value($essb_options, 'subscribe_mc_success9');
		$subscribe_mc_error = essb_object_value($essb_options, 'subscribe_mc_error9');
		...
		$subscribe_mc_image3 = essb_object_value($essb_options, 'subscribe_mc_image9');
		$subscribe_mc_imagealign3 = essb_object_value($essb_options, 'subscribe_mc_imagealign9');
		...
		$output .= '<div class="essb-subscribe-form-content-title">'.ESSBNetworks_Subscribe::sanitize_html($subscribe_mc_title).'</div>';
