...
if ($connector != 'mymail' && $connector != 'mailster' && $connector != 'mailpoet' && $connector != 'conversio') {
	...
	essb5_draw_input_option('subscribe_mc_customlist3', esc_html__('List ID', 'essb'), esc_html__('Optional you can set a different list for this form only. To get the list ID you can follow the instructions on the subscribe connector.', 'essb'), true);
}
...
essb5_draw_input_option('subscribe_mc_title3', esc_html__('Custom Form Title Text', 'essb'), esc_html__('Setup your own custom text for the title (ex.: Join Our List)', 'essb'), true);
essb5_draw_file_option('subscribe_mc_image3', esc_html__('Choose Image', 'essb'), esc_html__('Select image that will appear on the top or left part of the subscribe form', 'essb'));
...
essb5_draw_editor_option('subscribe_mc_text3', esc_html__('Form Text', 'essb'), esc_html__('Customize the default form text (ex.: Subscribe to our list and get awesome news.)', 'essb'));
...
essb5_draw_input_option('subscribe_mc_footer3', esc_html__('Footer Text', 'essb'), esc_html__('Add a footer text that will appear below form (ex.: We respect your privacy'), true);
...
essb5_draw_switch_option('activate_mailchimp_customizer3', esc_html__('Activate Color Changing', 'essb'), esc_html__('Set option to Yes for generating of color change', 'essb'));
